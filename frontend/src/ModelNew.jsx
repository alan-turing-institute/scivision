  ...
  return (
    <>
      ...
      <Row>
        <Col md={{ span: 8, offset: 2 }}>
          <ul>
            <li>
              {" "}
              The source code of your model is shared in a public repository
              (GitHub or elsewhere). The Scivision catalog does not host your
              model source code directly, just some metadata about it, so this
      ...
      <Row>
        <Col md={{ span: 8, offset: 2 }}>
          <p>
            Add some details about your model below. Submitting the form will
            open a pull request (from your GitHub user account) that adds
            details of your model to the catalog. Further discussion is possible
            at that point, so it doesn't need to be complete or perfect at this
            stage.
          </p>
          <p>
